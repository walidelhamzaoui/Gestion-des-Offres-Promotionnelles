            ...
            <ul class="navbar-navdashboard navbar-nav px-3 ">
                ...
                <li class="nav-item nav-itemdashboard"> <?php if ($user_role == 'admin'): ?>
                    <a href="tableau_de_bord.php"  class="nav-link nav-linkdashboard active  rounded-2 text-white"
                        class="btn btn-primary">Gestion des utilisateurs</a>
                    <?php endif; ?>
                </li>
                ...
                <li class="nav-item nav-itemdashboard "><a
                    ...
                    <li class="nav-item nav-itemdashboard "><a class="nav-link  nav-linkdashboard fs-6 "
                            ...
                            Offres</a></li>
                <li class="nav-item nav-itemdashboard"><a class="nav-link nav-linkdashboard" href="profil.php">Mon
                        profil</a></li>

                <li>
                    <a class="nav-link nav-linkdashboard" id="logout-link" href="deconnexion.php">Déconnexion</a></a>
                </li>
            </ul>
                ...
                <ul class="navbar-navdashboard navbar-nav px-2 text-center">
                    ...
                    <li class="nav-item nav-itemdashboard pt-2"> <?php if ($user_role == 'admin'): ?>
                        <a href="admin.php"class=" nav-link nav-linkdashboard active  rounded-2 text-white"
                            class="btn btn-primary"><i class="bi bi-people-fill" style="font-size:20px"></i> Gestion des utilisateurs</a>
                        <?php endif; ?>
                    </li>
                    ...
                    <li class="nav-item nav-itemdashboard "><a class="nav-link   nav-linkdashboard fs-6 "
                            ...
                            <i class="bi bi-gift-fill" style="font-size:20px"></i>
                            Offres</a></li>
                    <li class="nav-item nav-itemdashboard "><a class="nav-link nav-linkdashboard fs-6 " href="profil.php"><i class="bi bi-person-circle"style="font-size:20px"></i>Mon
                            Profil</a></li>

                    <li>
                        <a class="nav-link nav-linkdashboard fs-6" id="logout-link"
                            href="deconnexion.php"><i class="bi bi-power" style="font-size:20px"></i>Déconnexion</a></a>
                    </li>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                         <div class="p-5 pb-0 pt-0 d-flex justify-content-center align-items-center ">
                                <h4 class="col-12 p-2 px-5 text-white"  style="background: rgb(45,131,209);
background: linear-gradient(90deg, rgba(45,131,209,1) 0%, rgba(83,148,204,1) 65%, rgba(0,212,255,1) 100%); width:fit-content" >Liste des Utilisateurs</h4>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr >
                                                ...
                                                <td class="text-center pt-4">
                                                    <span class=" text-white rounded  text-center p-2 px-2 <?= $user['statut'] == 'actif' ? 'bg-success' : ($user['statut'] == 'refusé' ? 'bg-danger' : 'bg-warning') ?>">
